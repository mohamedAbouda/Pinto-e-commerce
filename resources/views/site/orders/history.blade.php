    ...
    <div class="container">
      ...
      @foreach($orders as $order)
                                        <tr>
                                            <td>
                                                <div class="delete">
                                                    <a href="{{route('web.order.submit.dispute',$order->id)}}" title=""><img src="{{asset('assets/site/images/dispute.png')}}" alt=""></a>
                                                </div>
                                                 </td>
                                              <td>
                                                <div class="product">
                                           ...
                                           <form action="{{route('web.user.reorder')}}" method="post">
                                                 ...
                                                 <input type="submit" value="Re order" style="backcolor: #484848">
                                              </form>
                                            </td>
                                        </tr>
                                     @endforeach
