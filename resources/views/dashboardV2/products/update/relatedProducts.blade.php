...
<div class="row">
    <div class="col-md-4 col-xs-12">
        <h3 class="section-title contacts-section-title">Create Related Products  </h3>
    </div>
    ...
    <div class="col-md-12">
        <div class="row">
            <form id="create-inventory" action="{{route('dashboard.store.related.products')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-12">
                    <h3 class="secondry-title">Related Products.</h3>
                </div>
                <div class="col-md-6">
                    <div class="form-group margin-bottom20">
                        <label class="control-label" for="formInput25">Choose Related Products</label><br>
