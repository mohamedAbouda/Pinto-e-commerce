...
<div class="row margin-top15">
    <div class="col-md-12">
        <div class="row">
              ...
              <form  id="main-form-submit" action="{{ route('dashboard.products.update', ['product' => $product->id]) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-12">
                    <div class="form-group margin-bottom20">
                        <label class="control-label" for="formInput25">{{ trans('web.dashboard_products_edit_product_name') }}</label>
                        <input type="text" class="form-control" id="formInput25" required name="name" value="{{$product->name}}">
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group margin-bottom20">
                        <label class="control-label" for="formInput25">{{ trans('web.dashboard_products_edit_category') }}</label>
                ...
                <div class="col-md-6">
                    <div class="form-group margin-bottom20">
                        <label class="control-label" for="formInput25">{{ trans('web.dashboard_products_edit_select_category_first') }}</label>
                        <select name="sub_category_id"  id="selectValue" class="form-control select2"  onchange="categoryChange()">
                          <option selected disabled>{{ trans('web.dashboard_products_edit_pricy') }}</option>
                      </select>
                  </div>
              </div>
            ...
            <div class="col-md-12">
                <div class="form-group margin-bottom20">
                    <label class="control-label" for="formInput25">{{ trans('web.dashboard_products_edit_short_description') }}</label>
            ...
            <div class="col-md-12">
                <div class="form-group margin-bottom20">
                    <label class="control-label" for="formInput25">{{ trans('web.dashboard_products_edit_description') }}</label>
                    <textarea  name="short_description" required class="form-control autogrow" rows="5" cols="5" >{{$product->short_description }}</textarea>
                </div>
            </div>
            <div class="col-md-12">
                <div class="form-group margin-bottom20">
                    <label class="control-label" for="formInput25">{{ trans('web.dashboard_products_edit_technical_spec') }}</label>
                    <textarea  name="description" class="form-control autogrow" rows="5" cols="5" id="description">{{$product->description}}</textarea>
                </div>
            </div>
            <div class="col-md-12">
                <div class="form-group margin-bottom20">
        ...
        <div class="col-md-12">
            <div class="form-group margin-bottom20">
                <label class="control-label" for="formInput25">{{ trans('web.dashboard_products_edit_product_shipping_cost') }}</label>
                @if($product->keyWord)
...
<div class="col-md-6">
    <div class="form-group margin-bottom20">
        ...
        <input type="checkbox" {{$product->generalProduct && $product->generalProduct->shipping_category ? 'checked':''}} value="1" id="formInput25"  name="shipping_category">{{ trans('web.dashboard_products_edit_shipping_by_merchant') }}
    </div>
...
<div class="col-md-6">
    <div class="form-group margin-bottom20">
        <label class="control-label" for="formInput25"></label>
        <input type="checkbox" id="formInput25"  name="shipping_merchant" {{$product->generalProduct && $product->generalProduct->shipping_cost ? 'checked':''}}>Shipping By Merchant<br>
...
<div class="col-md-6">
    <div class="form-group margin-bottom20">
        <label class="control-label" for="formInput25">{{ trans('web.dashboard_products_edit_choose_related_products') }}</label><br>
        @foreach($productsRelated as $pro)
        <input type="checkbox" value="{{$pro->id}}" {{in_array($pro->id,$relatedProductIds )? 'checked':''}} id="formInput25"  name="product_ids[]">{{$pro->name}}<br>
        @endforeach
    </div>
...
<div class="col-md-6">
    <div class="form-group margin-bottom20">
        <label class="control-label" for="formInput25">{{ trans('web.dashboard_products_edit_p_cover') }}</label>
...
<div class="col-md-12">
    <div class="form-group margin-bottom20">
        <label class="control-label" for="formInput25">{{ trans('web.dashboard_products_edit_product_images') }}</label>
    ...
    <div class="col-md-12">
        <div class="row">
            <form id="create-discount" action="{{route('dashboard.product.add.discount')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                    <div class="form-group margin-bottom20">
                        <label class="control-label" for="formInput25">{{ trans('web.dashboard_products_edit_count') }}</label>
                ...
                <div class="col-md-6">
                    <div class="form-group margin-bottom20">
                        <label class="control-label" for="formInput25">{{ trans('web.dashboard_products_edit_discount') }}</label>
            ...
            {{--     <div class="col-md-3">
                <div class="form-group margin-bottom20">
                    <label class="control-label" for="formInput25">{{ trans('web.dashboard_products_edit_picture') }}</label>
...
<div class="tab-pane fade" id="inventory">
  <form id="create-inventory" action="{{route('dashboard.save.product.inventory')}}" method="post" enctype="multipart/form-data">
    ...
    <div class="col-md-6">
        <div class="form-group margin-bottom20">
            <label class="control-label" for="formInput25">{{ trans('web.dashboard_products_edit_p_size') }}</label>
    ...
    <div class="col-md-6">
        <div class="form-group margin-bottom20">
            <label class="control-label" for="formInput25">{{ trans('web.dashboard_products_edit_p_color') }}</label>
    ...
    <div class="col-md-6">
        <div class="form-group margin-bottom20">
            <label class="control-label" for="formInput25">{{ trans('web.dashboard_products_edit_p_sku') }}</label>
    ...
    <div class="col-md-6">
        <div class="form-group margin-bottom20">
            <label class="control-label" for="formInput25">{{ trans('web.dashboard_products_edit_p_amount') }}</label>
       ...
       <div class="col-md-12">
                    <div class="form-group margin-bottom20">
                        <label class="control-label" for="formInput25">{{ trans('web.dashboard_products_edit_p_weight') }}</label>
 ...
 <div class="col-md-12">
    <div class="form-group margin-bottom20">
        <label class="control-label" for="formInput25">{{ trans('web.dashboard_products_edit_note') }}</label>
