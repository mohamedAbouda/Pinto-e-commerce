             ...
             <form id="create-category" action="{{route('dashboard.about.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12">
                            <div class="form-group margin-bottom20">
                                <label class="control-label" for="formInput25">{{ trans('web.dashboard_about_pages_create_page_about') }} </label>
                             <textarea class="form-control ck"  name="body">{{old('description')}}</textarea>
                            </div>
