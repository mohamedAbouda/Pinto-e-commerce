...
<div class="row">
    <div class="col-md-4 col-xs-12">
        <h3 class="section-title contacts-section-title">
            {{ trans('web.dashboard_sections_pages_index_page_section_title_sections') }}
        </h3>
    </div>
    ...
    <div class="col-md-4 col-md-offset-1 text-right col-xs-11">
        <a class="btn btn-blue margin-left-10" href="{{route('dashboard.categories.create')}}">
            <span>+ </span>{{ trans('web.dashboard_sections_pages_index_page_create_button') }}
        </a>
    </div>
</div>
@stop
            ...
            <div class="col-md-4 margin-bottom10 margin-top20">
                <div class="total-customer-col pad5 pad-bottom5 col-md-12">
                    <div class="col-md-9 customer-stat-col-pad">
                        <h5 class="customer-stat-text pad5">{{ trans('web.dashboard_sections_pages_index_page_total_sections_count') }}</h5>
                    </div>
            ...
            <table class="table table-borderless table-responsive">
                <tbody>
                    <tr>
                        ...
                        <th>
                            {{ trans('web.dashboard_sections_pages_index_page_table_header_name') }}
                        </th>
                        <th>
                            {{ trans('web.dashboard_sections_pages_index_page_table_header_action') }}
                        </th>
                    </tr>
