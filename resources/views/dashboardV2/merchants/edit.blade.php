...
<div class="row">
    <div class="col-md-4 col-sm-12">
        <h3 class="section-title">{{trans('web.dashboard_mrechant_pages_edit_edit_merchant')}}</h3>
    </div>
...
@section('content')
<form action="{{ route('dashboard.merchants.update', ['user' => $user->id]) }}" method="post" enctype="multipart/form-data">
...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="form-group margin-bottom20 col-md-12">
            ...
            {{ Form::text('address', $user->address ? $user->address->address : '',['id'=>'address','class' => 'form-control']) }}
        ...
        <div class="form-group margin-bottom20 col-md-6">
            ...
            {{ Form::text('country',$user->address ? $user->address->country : '',['id'=>'country','class' => 'form-control']) }}
        ...
        <div class="form-group margin-bottom20 col-md-6">
            ...
            {{ Form::text('city', $user->address ? $user->address->city : '',['id'=>'city','class' => 'form-control']) }}
         ...
         <div class="form-group margin-bottom20 col-md-12">
           ...
           <input type="radio" name="corporate_deal_check" {{$user->corporate_deal_check == 0 ? 'checked':''}} value="0"> Can't add Corporate Deal<br>       
           <input type="radio" {{$user->corporate_deal_check == 1 ? 'checked':''}} name="corporate_deal_check" value="1"> Can add Corporate Deal<br>   
        </div>
