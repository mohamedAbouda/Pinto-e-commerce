...
<div class="row">
    <div class="col-md-4 col-sm-12">
        <h3 class="section-title">
            {{ trans('web.dashboard_offers_pages_edit_page_section_header_edit_product_offer') }}
        </h3>
    </div>
</div>
@stop
...
@section('content')
{{ Form::open(['route' => ['dashboard.offers.update',$resource->id] , 'method' => 'PATCH']) }}
<div class="row">
    <div class="col-md-12">
        <h3 class="secondry-title">{{ trans('web.dashboard_offers_pages_create_page_offer_info') }}.</h3>
    </div>
    <div class="col-md-12">
        <div class="form-group margin-bottom20 col-md-12">
            ...
            {{ Form::select('product_id', $products , $resource->product_id ,['id'=>'product_id','required'=>'required','class' => 'form-control']) }}
        ...
        <div class="form-group margin-bottom20 col-md-12">
            ...
            {{ Form::number('percentage', $resource->percentage ,['id'=>'percentage','min'=>0,'required'=>'required','class' => 'form-control']) }}
        ...
        <div class="form-group margin-bottom20 col-md-6">
            ...
            {{ Form::text('activation_start', $resource->activation_start ,['id'=>'activation_start','required'=>'required','class' => 'form-control' , 'placeholder' => 'YYYY-MM-DD HH:MM:SS']) }}
        ...
        <div class="form-group margin-bottom20 col-md-6">
            ...
            {{ Form::text('activation_end', $resource->activation_end ,['id'=>'activation_end','required'=>'required','class' => 'form-control' , 'placeholder' => 'YYYY-MM-DD HH:MM:SS']) }}
