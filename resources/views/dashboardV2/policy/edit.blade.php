...
@section('content')
<div class="col-md-12">
    <form action="{{ route('dashboard.policy.update', ['policy' => $policy->id]) }}" method="post"  enctype="multipart/form-data">
        <input type="hidden" name="_method" value="PUT">
        {{ csrf_field() }}
        <div class="col-md-12">
            <div class="form-group">
                <textarea name="body" class="form-control">{{ $policy->description }}</textarea>
            </div>
...
var tr_counter = {{ $policy_faq->count() }};
