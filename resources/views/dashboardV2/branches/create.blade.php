...
<div class="row">
    <div class="col-md-4 col-sm-12">
        <h3 class="section-title">{{ trans('web.dashboard_branches_pages_create_page_section_title_create_branch') }}</h3>
    </div>
</div>
@stop

@section('content')
{{ Form::open(['route' => 'dashboard.branches.store']) }}
<div class="row">
    <div class="col-md-12">
    ...
    <div class="col-md-12">
        <div class="form-group margin-bottom20 col-md-12">
            ...
            {{ Form::text('name', old('name') ,['id'=>'name','required'=>'required','class' => 'form-control' , 'placeholder' => 'Branch name']) }}
        ...
        <div class="form-group margin-bottom20 col-md-12">
            ...
            {{ Form::select('governorate_id', $governorates , null ,['id'=>'governorate_id','required'=>'required','class' => 'form-control']) }}
