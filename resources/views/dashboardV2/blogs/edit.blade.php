...
<div class="row">
    <div class="col-md-4 col-sm-12">
        <h3 class="section-title">Edit article</h3>
    </div>
</div>
@stop

@section('content')
{{ Form::open(['route' => ['dashboard.blog.update' ,$resource->id] ,'files'=>'true' ,'method' => 'PATCH']) }}
<div class="row">
    <div class="col-md-12">
    ...
    <div class="col-md-12">
        <div class="form-group margin-bottom20 col-md-4">
            <div class="admin-preview">
                ...
                <label for="cover_image" style="width:100%;">
                    <img src="{{ $resource->cover_image ? $resource->cover_image_url : asset('assets/panel-assets/images/profile-picutre/01_img.png') }}" class="thumbnail image-item" alt="Upload picture" style="width:100%;cursor: pointer; cursor: hand;border: 3px solid #0081ff;">
        ...
        <div class="form-group margin-bottom20 col-md-6">
            ...
            {{ Form::select('categories[]' ,$categories ,$resource->categories()->pluck('blog_categories.id')->toArray() ,['id'=>'categories','class' => 'form-control' ,'multiple' => 'multiple']) }}
        ...
        <div class="form-group margin-bottom20 col-md-12">
            ...
            {{ Form::textarea('short_description' ,$resource->short_description ,['id'=>'short_description','required'=>'required','class' => 'form-control']) }}
        ...
        <div class="form-group margin-bottom20 col-md-12">
            ...
            {{ Form::textarea('body' ,$resource->body ,['id'=>'body','required'=>'required','class' => 'form-control']) }}
