...
{{ Form::open(['route' => ['dashboard.storelocations.update' ,$location->id] ,'method' => 'PATCH']) }}
    <div id="autoMap">
    ...
    <div class="col-md-6">
        <div class="form-group">
            <input type="hidden" class="form-control" name="latitude" id="lat" value="{{ $location->latitude }}">
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="hidden" class="form-control" name="longitude" id="lng" value="{{ $location->longitude }}">
        </div>
    </div>
    <div class="col-md-12">
        <div class="form-group">
            <label>{{ trans('web.dashboard_sub_store_locations_edit_address') }}</label>

            <input type="text" class="form-control" name="Searchaddress" id="Searchaddress">
        </div>
    </div>
    <input type="hidden" name="address" id="add" value="{{ $location->address }}">
    <div class="col-md-6">
        <div class="form-group">
            <button class="btn btn-primary">{{ trans('web.dashboard_sub_store_locations_edit_save') }}</button>
        </div>
    </div>
{{ Form::close() }}
<div class="col-md-6">
    <div class="form-group">
        <button class="btn btn-primary" id="myLocation">{{ trans('web.dashboard_sub_store_locations_edit_get_my_location') }}</button>
    </div>
</div>
@endsection
@section('scripts')
