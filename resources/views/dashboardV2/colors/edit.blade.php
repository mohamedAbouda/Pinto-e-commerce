...
<div class="row">
    <div class="col-md-4 col-xs-12">
        <h3 class="section-title contacts-section-title">{{ trans('web.dashboard_colors_pages_create_page_color_title_edit_color') }}</h3>
    </div>
            ...
            <form id="update-color" action="{{route('dashboard.colors.update',['id'=>$color->id])}}" method="post"
                ...
                <div class="col-md-6">
                    <div class="form-group margin-bottom20">
                        ...
                        <input type="text" class="form-control" id="formInput25" required name="name" value="{{$color->name}}">
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group margin-bottom20">
                        ...
                        <input type="color" name="code" class="form-control" value="{{$color->code}}">
                    </div>
                </div>
