...
<div class="row margin-top15">
    <div class="col-md-12">
        <div class="row">
            <form id="create-category" action="{{route('dashboard.gift_cards.store')}}" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <div class="form-group margin-bottom20">
                        ...
                        <input type="text" class="form-control" id="formInput25" required name="code" value="{{$code}}">
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group margin-bottom20">
                        ...
                        <input type="number" min="0" step="any" name="discount"  class="form-control">
                        <div style="color:red">
