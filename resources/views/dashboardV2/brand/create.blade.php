...
<div class="row">
    <div class="col-md-4 col-xs-12">
        <h3 class="section-title contacts-section-title">
            {{ trans('web.dashboard_brands_pages_create_page_section_title_create_brand') }}
        </h3>
    </div>
...
<div class="row margin-top15">
    <div class="col-md-12">
        <div class="row">
            <form id="create-category" action="{{route('dashboard.brands.store')}}" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="col-md-12">
                    <h3 class="secondry-title">
                        {{ trans('web.dashboard_brands_pages_create_page_brand_info') }}.
                    </h3>
                </div>
                <div class="col-md-6">
