...
<section class="box ">
    ...
    <header class="panel_header">
        <h2 class="title pull-left">Create new Admin</h2>
        <div class="actions panel_actions pull-right"></div>
    </header>

    <div class="content-body">
        <div class="row">
            <form id="create-category" action="{{route('dashboard.admins.index')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="form-group">
                        <label class="form-label" for="name">Admin E-mail</label>
                        <span class="desc"></span>
                        <div class="controls">
