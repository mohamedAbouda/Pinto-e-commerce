...
<section class="box ">
    ...
    <div class="content-body">
        <div class="row">
            {{ Form::open(['route'=>['dashboard.deal.store'] , 'files' => TRUE]) }}
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="form-group">
                    <label for="product">
                        Product
                    </label>
                    <span class="desc">products which have no discounts</span>
                    <div class="controls">
                        {{ Form::select('product_id' , $products , NULL , ['id' => 'product' , 'class' => 'form-control']) }}
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div id="datetime-from" class="datetimepicker" data-default-date=""></div>
                            <input type="hidden" name="activation_start" value="">
                        </div>
                        <div class="col-md-6">
                            <div id="datetime-to" class="datetimepicker" data-default-date=""></div>
                            <input type="hidden" name="activation_end" value="">
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="controls">
                        <input type="number" min=0 name="percentage" id="percentage" class="form-control">
                    </div>
                ...
                <div class="form-group">
                    <label for="active">
                        Is active :
                        <input type="checkbox" name="active" id="active" class="" value="1" checked="checked">
                    </label>
