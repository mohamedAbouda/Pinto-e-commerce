...
@section('content')
  <section class="box ">
    ...
    <header class="panel_header">
      <h2 class="title pull-left">Edit category, {{$category->name}}</h2>
      <div class="actions panel_actions pull-right"></div>
    </header>

    <div class="content-body">
      <div class="row">
        <form id="update-category" action="{{route('dashboard.categories.update',['id'=>$category->id])}}" method="post"
          ...
          <div class="col-lg-8 col-md-8 col-sm-9 col-xs-12">
            ...
            <div class="form-group">
                <label class="form-label" for="Icon">
                    Icon : "<i class="fa {{ $category->icon }}"></i>"
                </label>
            ...
            <div class="form-group">
              ...
              <span class="desc"></span>
              <div class="controls">
                <textarea form="update-category" name="description" class="form-control autogrow" rows="5" cols="5"
            ...
            <div class="form-group">
                ...
                <div class="clearfix"></div>
                <img src="{{ url('storage/app/'.$category->banner) }}" alt="" class="thumbnail" style="width:241px;height:165px;">
                <p class="desc">
