...
<section class="box ">
    <header class="panel_header">
        <h2 class="title pull-left">Create a coupon</h2>
    </header>

    <div class="content-body">
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12 ">
                {{ Form::open(['route' => 'dashboard.coupons.store']) }}
                <div class="row">
                    <div class="">
                        <label for="code">
                            Code :
                ...
                <div class="row">
                    ...
                    <div class="col-md-12" style="margin-bottom: 10px;">
                        {{ Form::number('percentage' , 0 , ['class' => 'form-control' , 'id' => 'percentage' , 'min' => '0' , 'autocomplete' => 'off']) }}
                    </div>
                </div>
