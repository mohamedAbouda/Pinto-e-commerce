...
class Kernel extends HttpKernel
{
    ...
    protected $middlewarePriority = [
        ...
        \App\Http\Middleware\DashboardIntialization::class,
        \App\Http\Middleware\FirstTimeDashboardAccess::class,
    ];
    ...
    protected $routeMiddleware = [
        ...
        'first' => \App\Http\Middleware\FirstTimeDashboardAccess::class,
