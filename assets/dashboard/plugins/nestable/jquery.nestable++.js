...
var editMenuItem = function () {
  ...
  var newSlug;
  if ($("#editSelectSlug").val() != '') {
      newSlug = $("#editSelectSlug").val();
  }else if(editInputSlug.val() != ''){
...
var addToMenu = function () {
  ...
  var newSlug;
  if ($("#addSelectSlug").val() != '') {
      newSlug = $("#addSelectSlug").val();
  }else if($("#addInputSlug").val() != ''){
      newSlug = $("#addInputSlug").val();
  }else{
      $("#addInputSlug").focus();
      return;
  }
